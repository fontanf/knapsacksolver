...
void sopt_balknap_main(Instance& ins, BalknapOptionalParameters& p, BalknapOutput& output);

BalknapOutput knapsack::sopt_balknap(Instance& ins, BalknapOptionalParameters p)
{
    VER(p.info, "*** balknap");
...
void sopt_balknap_update_bounds(BalknapInternalData& d);
