...
Profit opt_bellman_array_one_test(Instance& ins)   { Info info; return sopt_bellman_array_one(ins, info).profit(); }
Profit opt_bellman_array_part1_test(Instance& ins) { Info info; return sopt_bellman_array_part(ins, info, 1).profit(); }
Profit opt_bellman_array_part2_test(Instance& ins) { Info info; return sopt_bellman_array_part(ins, info, 2).profit(); }
Profit opt_bellman_array_part3_test(Instance& ins) { Info info; return sopt_bellman_array_part(ins, info, 3).profit(); }
Profit opt_bellman_array_rec_test(Instance& ins)   { Info info; return sopt_bellman_array_rec(ins, info).profit(); }
Profit opt_bellman_list_test(Instance& ins)        { Info info; return opt_bellman_list(ins, info); }
//Profit opt_bellman_list_all_test(Instance& ins)    { Info info; return sopt_bellman_list_all(ins, info).profit(); }
//Profit opt_bellman_list_one_test(Instance& ins)    { Info info; return sopt_bellman_list_one(ins, info).profit(); }
//Profit opt_bellman_list_part1_test(Instance& ins)  { Info info; return sopt_bellman_list_part(ins, info, 1).profit(); }
//Profit opt_bellman_list_part2_test(Instance& ins)  { Info info; return sopt_bellman_list_part(ins, info, 2).profit(); }
//Profit opt_bellman_list_part3_test(Instance& ins)  { Info info; return sopt_bellman_list_part(ins, info, 3).profit(); }
Profit opt_bellman_list_rec_test(Instance& ins)    { Info info; return sopt_bellman_list_rec(ins, info).profit(); }
