#include "knapsacksolver/subsetsum/generator.hpp"
...
Instance knapsacksolver::subsetsum::generate_pthree(
...
Instance knapsacksolver::subsetsum::generate_psix(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_evenodd(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_avis(
        ItemPos number_of_items)
{
...
Instance knapsacksolver::subsetsum::generate_todd(
        ItemPos number_of_items)
{
    ItemPos n = number_of_items;
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_somatoth(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_evenodd6(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_evenodd8(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_tenfive6(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
...
Instance knapsacksolver::subsetsum::generate_tenfive8(
        ItemPos number_of_items,
        std::mt19937_64& generator)
{
    Instance instance;
