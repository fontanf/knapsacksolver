...
std::ostream& knapsacksolver::knapsack::operator<<(std::ostream& os, const Solution& solution)
{
...
Profit knapsacksolver::knapsack::algorithm_end(Profit upper_bound, Info& info)
{
    double t = round(info.elapsed_time() * 10000) / 10;
    info.add_to_json("Bound", "Value", upper_bound);
    info.add_to_json("Bound", "Time", t);
