...
Output knapsacksolver::knapsack::greedy_nlogn_forward(const Instance& instance, Info info)
{
...
Output knapsacksolver::knapsack::greedy_nlogn_backward(const Instance& instance, Info info)
{
...
Output knapsacksolver::knapsack::greedy_nlogn(
